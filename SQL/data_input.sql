-- Membuat Database bernama 'latihan'
CREATE DATABASE IF NOT EXISTS latihan;

USE latihan;

-- Membuat Tabel bernama 'bands'
...
-- Melihat semua isi dalam tabel 'albums'
select * from albums;

-- Melihat semua isi dalam tabel 'bands'
select * from bands;

-- Melihat semua isi dalam tabel 'songs'
select * from songs;
...
-- Misal akan dihapus 1 kolom dari tabel albums
alter table albums
drop column name;

--  Misal akan dihapus 1 baris dari tabel albums
delete from songs where name = "Frodo's Dream";
